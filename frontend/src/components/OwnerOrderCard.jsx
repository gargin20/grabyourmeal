    ...
    return (
        <div className='bg-white rounded-lg shadow p-4 space-y-4'>
            ...
            <div className='flex justify-between items-center mt-auto pt-3 border-t border-gray-100'>
                ...
                <select className='rounded-md border px-3 py-1 text-sm focus:outline-none focus:ring-2 border-[#ff4d2d] text-[#ff4d2d] disabled:opacity-50 disabled:cursor-not-allowed'
                    onChange={(e) => handleUpdateStatus(data._id, data.shopOrders.shop._id, e.target.value)}
                    disabled={data.shopOrders.status === "delivered"}
